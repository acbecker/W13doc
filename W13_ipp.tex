...
%The masterbias, masterdark,
%and masterflat will be applied to the input calibration data. 
...
production.
%, and it required multiple weeks of honing database queries
