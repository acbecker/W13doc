...
XXX and 1.75 degrees respectively. Rotational dithering is based on
...
will be staged at JHU and then transferred to NCSA.  Registry
generation time is ~10min per visit.  
...
We will need to solve the
problem of how to point to the correct flat in the registry given a
rotator angle for the science image.  This has not been done before.
