...
-- id -- unique integer id of the object traceable back to the base catalogs
...
-- galaxy position angle in degrees (do we measure these, or should we give these in both components)
...
-- set of master calibration frames.
...
-- matchedMSE: the MSE of the reference and matched images, mean((refImage - matchedSciImage)**2);   should be comparable to the mean variance of the difference image.
