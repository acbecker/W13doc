...
0, indicating a constant matching kernel across the iamge.  {\it For
  this reason it may be desirable to test out the delta--function
  kernel set in this environment}.  Second the size of the matching
kernel is approximately half the size of the ImagePsfMatchTask
matching kernel because shape is expected to be approximately a delta
function.  Finally, the sum--of--Gaussian basis set is smaller (21
