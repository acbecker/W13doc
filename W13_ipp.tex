...
The output is a set of coadd temp exposures ("deepCoadd_tempExp" or "goodSeeingCoadd_tempExp").
...
querying the Science_Ccd_Exposure table of a database of information about calexp.
...
The current Science_Ccd_Exposure table and SelectImagesTask need improvement.
The only measure of image quality that Science_Ccd_Exposure contains is PSF FWHM.
